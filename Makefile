...
all: test_uart_tx test_baud_gen test_uart_rx test_uart_loopback test_spi_master test_spi_slave test_spi_loopback test_spi_modes test_i2c_start_stop test_i2c_ack_nack
